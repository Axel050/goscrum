...
// // import { getTasks } from "../store/actions/taskActions/getTasks";
// // import { getTasks } from "../../store/actions/taskActions/getTasks";
// import { getTasks } from "../../store/actions/taskActions.js";
// // \store\actions\taskActions.js
...
//   ///* useEffect(() => {
//   //   setLoading(true);
//   //   fetch(`https://goscrum-api.alkemy.org/task${who === "ME" ? "/me" : ""}`, {
//   //     headers: {
...
//   //       if (importance !== "ALL")
//   //         setListRender(
//   //           data?.result.filter((el) => el.importance === importance)
//   //         );
//   //       else {
//   //         setListRender(data?.result);
//   //       }
//   //       setTimeout(() => {
//   //         setLoading(false);
//   //       }, 2000);
//   //     });
//   // }, [who, importance, token]);
